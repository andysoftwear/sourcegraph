				...
				Rows: []monitoring.Row{
					...
					{
						{
							...
							Query:          `sum by(name) (rate(src_github_rate_limit_wait_duration{resource="graphql"}[5m]))`,
						...
						},
						{
							...
							Query:          `sum by(name) (rate(src_github_rate_limit_wait_duration{resource="rest"}[5m]))`,
							Panel:          monitoring.Panel().LegendFormat("{{name}}").Unit(monitoring.Seconds),
							Owner:          monitoring.ObservableOwnerCloud,
							NoAlert:        true,
							Interpretation: `Indicates how long we're waiting on the rate limit once it has been exceeded'`,
						},
						{
							...
							Query:          `sum by(name) (rate(src_github_rate_limit_wait_duration{resource="search"}[5m]))`,
							Panel:          monitoring.Panel().LegendFormat("{{name}}").Unit(monitoring.Seconds),
							Owner:          monitoring.ObservableOwnerCloud,
							NoAlert:        true,
							Interpretation: `Indicates how long we're waiting on the rate limit once it has been exceeded'`,
					...
					},
					{
						...
						},
						{
							...
							Query:          `sum by(name) (rate(src_gitlab_rate_limit_wait_duration{resource="rest"}[5m]))`,
							Panel:          monitoring.Panel().LegendFormat("{{name}}").Unit(monitoring.Seconds),
							Owner:          monitoring.ObservableOwnerCloud,
							NoAlert:        true,
							Interpretation: `Indicates how long we're waiting on the rate limit once it has been exceeded'`,
